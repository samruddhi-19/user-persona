...
export function CheckIcon({ width = 20, height = 20, strokeWidth = 2.5, ...props }) {
  return (
    <svg
      width={width}
      height={height}
...
export function ArrowLeftIcon({ width = 16, height = 16, ...props }) {
  return (
    <svg
      width={width}
      height={height}
...
export function ShieldLockIcon({ width = 20, height = 20, ...props }) {
  return (
    <svg
      width={width}
      height={height}
...
export function UserPersonaIcon({ width = 20, height = 20, ...props }) {
  return (
    <svg
      width={width}
      height={height}
...
export function ExternalLinkIcon({ width = 14, height = 14, ...props }) {
  return (
    <svg
      width={width}
      height={height}
...
export function ImageIcon({ width = 16, height = 16, ...props }) {
  return (
    <svg
      width={width}
      height={height}
...
export function FileSpreadsheetIcon({ width = 18, height = 18, ...props }) {
  return (
    <svg
      width={width}
      height={height}
...
export function CompactViewIcon({ width = 14, height = 14, ...props }) {
  return (
    <svg
      width={width}
      height={height}
...
export function DetailedViewIcon({ width = 14, height = 14, ...props }) {
  return (
    <svg
      width={width}
      height={height}
